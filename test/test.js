...
describe('HTML and CSS', function() {
    it('should get right critical', async function() {        
        ...
        assert.equal(res.critical, 'p:hover a:first-child{color: red;}');
    });
    ...
    it('should get right rest', async function() {        
        ...
        assert.equal(res.rest, '.card{padding: 8px;}');
...
describe('localServer', function() {
    it('should get right critical', async function() {        
        ...
        assert.equal(res.critical, 'html{font-size: 10pt;}div{color: red;}');
    });
    ...
    it('should get right rest', async function() {        
        ...
        assert.equal(res.rest, 'p{color: red;}');
